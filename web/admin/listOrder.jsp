...
<div class="workingArea">
	<h1 class="label label-info" >Manage order</h1>
	<br>
	<br>
			...
			<tbody>
				<c:forEach items="${os}" var="o">
					<tr>
						<td>${o.id}</td>
						<td>${o.statusDesc}</td>
						<td>RM <fmt:formatNumber type="number" value="${o.total}" minFractionDigits="2"/></td>
						...
						<td>
							<button oid=${o.id} class="orderPageCheckOrderItems btn btn-primary btn-xs">Detail</button>
									...
									<c:forEach items="${o.orderItems}" var="oi">
										<tr>
											...
											<td align="right">
												...
												<span class="text-muted">Unit Price：RM ${oi.product.promotePrice}</span>
											</td>
